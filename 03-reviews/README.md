...
The project is hosted on Netlify, so as an alternative to running it locally, you can visit the link [here](https://reviews-horpeazy.netlify.app/) to see how the application works in real time.
